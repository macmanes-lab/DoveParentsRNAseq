...
## Table 1: comparison of total DEGs determined by edgeR and DESeq2

## Fig 1: Total number of gene expression differences between each stage
...
**Fig x. The magnitude of gene expression changes between each parental transition**.
...
```{r, message=FALSE, warning=FALSE, cache=TRUE, echo = F, fig.width= 5}
ggdraw() + draw_image("../figures/sexes/DoveParentsRNAseq_model2.png") 
```
