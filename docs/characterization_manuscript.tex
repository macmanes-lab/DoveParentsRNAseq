...
\hypertarget{table-1-comparison-of-total-degs-determined-by-edger-and-deseq2}{%
\subsection{Table 1: comparison of total DEGs determined by edgeR and
DESeq2}\label{table-1-comparison-of-total-degs-determined-by-edger-and-deseq2}}

\hypertarget{fig-1-total-number-of-gene-expression-differences-between-each-stage}{%
\subsection{Fig 1: Total number of gene expression differences between
each
stage}\label{fig-1-total-number-of-gene-expression-differences-between-each-stage}}

\includegraphics{characterization_manuscript_files/figure-latex/unnamed-chunk-4-1.pdf}

\textbf{Fig x. The magnitude of gene expression changes between each
