...
Removal of offspring around the time of chicks hatching causes circulating prolactin to plummet and gene expression patterns shift to a non-parental state, suggesting an external stimulus-driven response; however prolonging incubation or delaying hatch have a much more subtle effect on gene expression. 
