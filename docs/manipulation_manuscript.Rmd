...
```{r, message=FALSE, warning=FALSE, cache=TRUE, echo = F, fig.width= 5, fig.cap= "Circulating prolactin levels with an without manipulation."}
ggdraw() + draw_image("../figures/hormones/prolactin-manip-1.png") 
```

```{r, message=FALSE, warning=FALSE, cache=TRUE, echo = F, fig.width= 5, fig.cap= "Offspring removal."}
ggdraw() + draw_image("../figures/manipulation/offspringremoval-1.png") 
```



```{r, message=FALSE, warning=FALSE, cache=TRUE, echo = F, fig.width= 5, fig.cap = "Manipulation of timing of hatch with dummy eggs and foster chicks. "}
