...
```{r write}
write.csv(colData_manipluation, "../results/00-colData-manipluation.csv", row.names = TRUE) 
write.csv(countData_manipluation, "../results/countData-manipluation.csv", row.names = TRUE) 
write.csv(colData_characterization, "../results/00-colData-characterization.csv", row.names = TRUE) 
