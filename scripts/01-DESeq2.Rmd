...
```{r}
colData <- read.csv("../results/00-colData_characterization.csv", header = T, row.names = 1)
countData <- read.csv("../results/00-countData_characterization.csv", header = T, row.names = 1)
```

```{r deseq2}
dds <- DESeqDataSetFromMatrix(countData, colData, ~ sex*treatment)
