...
createDEGdftreatmentvcontrols(ddsMP, "male_pituitary", "control", "bldg")
createDEGdftreatmentvcontrols(ddsMP, "male_pituitary", "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsMP, "male_pituitary", "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsMP, "male_pituitary", "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsMP, "male_pituitary", "hatch", "m.n2")
...
createDEGdftreatmentvcontrols(ddsFP, "female_pituitary", "control", "bldg")
createDEGdftreatmentvcontrols(ddsFP, "female_pituitary", "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsFP, "female_pituitary", "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsFP, "female_pituitary", "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsFP, "female_pituitary", "hatch", "m.n2")
...
createDEGdftreatmentvcontrols(ddsMG, "male_gonads", "control", "bldg")
createDEGdftreatmentvcontrols(ddsMG, "male_gonads", "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsMG, "male_gonads", "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsMG, "male_gonads", "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsMG, "male_gonads", "hatch", "m.n2")
...
createDEGdftreatmentvcontrols(ddsFG, "female_gonads", "control", "bldg")
createDEGdftreatmentvcontrols(ddsFG, "female_gonads",  "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsFG, "female_gonads",  "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsFG, "female_gonads",  "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsFG, "female_gonads", "hatch", "m.n2")
...
createDEGdftreatmentvcontrols(ddsMH, "male_hypothalamus", "control", "bldg")
createDEGdftreatmentvcontrols(ddsMH, "male_hypothalamus",  "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsMH, "male_hypothalamus",  "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsMH, "male_hypothalamus", "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsMH, "male_hypothalamus", "hatch", "m.n2")
...
createDEGdftreatmentvcontrols(ddsFH, "female_hypothalamus", "control", "bldg")
createDEGdftreatmentvcontrols(ddsFH, "female_hypothalamus",  "inc.d3", "m.inc.d3")
createDEGdftreatmentvcontrols(ddsFH, "female_hypothalamus", "inc.d9", "m.inc.d9")
createDEGdftreatmentvcontrols(ddsFH, "female_hypothalamus", "inc.d17", "m.inc.d17")
createDEGdftreatmentvcontrols(ddsFH, "female_hypothalamus", "hatch", "m.n2")
