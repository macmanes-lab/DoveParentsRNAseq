...
AVP, DRD1, GNAQ, MBD2, NR3C1, OXT, PRL, PTEN, ZFX
    ...
    # top GOs of these genes: endocrine porcess, regulation of blood pressure (by hormones or chemical signals), system process, regulation of hormone levels
...
CREBRF, DBH, PRL
    ...
    # top Gos maternal, parental, reproductive behavior; reproduction, reproductive process
...
PTEN
    ...
    # response to chemical, maternal and parental beahviors, regulation of RNApolI transscription
...
PRL
    ...
    # (cellular) response to organic substance, endocrine process, response to stimulus, response to chemical 
...
PRL
    ...
    # endocrine process, system process, hormone transport, synaptic transmission (dopamineric), secretion by cell
...
NA
    ...
    # (positive) regulation of gap junction assembly, regulation of cardiac conduction, regualation of blood pressure
