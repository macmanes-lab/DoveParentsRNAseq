...
for (eachdds in mydds){
  ...
  totalDEGSname <- paste("totalDEGS", eachgroup, sep = "")
  assign(paste("totalDEGS", eachgroup, sep = ""), totalDEGS)
  return(totalDEGSname)
}

a <- plottotalDEGs(totalDEGSfemale_hypothalamus, "female hypothalamus")
b <- plottotalDEGs(totalDEGSfefemale_pituitary, "female pituitary")
c <- plottotalDEGs(totalDEGSmale_gonad, "female gonad")
d <- plottotalDEGs(totalDEGSmale_hypothalamus, "male hypothalamus")
e <- plottotalDEGs(totalDEGSmale_pituitary, "male pituitary")
f <- plottotalDEGs(totalDEGSmale_gonad, "male gonad")
...
p1 <- candidatecounts %>%
  ...
  labs(subtitle = eachgroup, x = NULL) +
