...
plot.volcano(sex, "sex", "male", "female", colorsvolcano) 
```



```{r volcanos-pit-manip}
...
remove <- plot_grid(a + labs(y = "pituitary -log10(p-value)"),
...
timing <- plot_grid(e +  labs(y = "pituitary -log10(p-value)"),
