...
venn.diagram(
  ...
  filename = '../figures/venn-chicks-hyp.png',
  output=FALSE,
  print.mode = "raw",
  imagetype = "png",
  col=c('#3182bd', "#6baed6",  '#cbc9e2', '#6a51a3', '#08519c'),
  fill = c("#3182bd", "#6baed6", "#cbc9e2", '#6a51a3', "#08519c" ),
  main = "Hypothalamus - Nestling Care",
  sub = "Differentially expressesed genes relative to nest building controls"
  )
...
venn.diagram(
  ...
  filename = '../figures/venn-eggs-hyp.png',
  output=FALSE,
  print.mode = "raw",
  imagetype = "png",
  height = 1500,
...
```{r}
library(cowplot)
eggshyp <- png::readPNG("../figures/venn-eggs-hyp.png")
eggshyp <- ggdraw() +  draw_image(eggshyp, scale = 1)

plot_grid(eggshyp,eggshyp, eggshyp, nrow = 1)
```
