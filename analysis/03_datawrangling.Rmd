...
venn.diagram(
  ...
  filename = '../figures/venn-gonad.png',
  output=FALSE,
  print.mode = "raw",
  col=c("#CDCDCD", '#262625', '#959595','#959595'),
  fill = c("#CDCDCD", "#262625", "#959595", "#959595"),
  main = "Gonads",
  sub = "zero genes respond to all four offspring removal manipulations"
  #main = "Pituitary",
  #sub = "Six genes respond to all four offspring removal manipulations\n SSTR3, VTN, SARM1, ALK, LPAR1, and PHGDH"
  #main = "Hypothalamus",
  #sub = "Zero genes respond to all four offspring removal manipulations"
