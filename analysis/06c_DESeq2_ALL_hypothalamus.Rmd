...
```{r eval=T}
control.bldg <- createDEGdfsave(dds.hypothalamus, "treatment", "bldg", "control", "hypothalamus")
```

```{r  eval=T}
bldg.lay <- createDEGdfsave(dds.hypothalamus, "treatment", "lay", "bldg", "hypothalamus")
```

```{r  eval=T}
lay.inc.d3 <- createDEGdfsave(dds.hypothalamus, "treatment", "inc.d3", "lay", "hypothalamus") 
```

```{r  eval=T}
inc.d3.inc.d9 <- createDEGdfsave(dds.hypothalamus,  "treatment", "inc.d9", "inc.d3", "hypothalamus") 
```

```{r  eval=T}
inc.d9.inc.d17 <- createDEGdfsave(dds.hypothalamus, "treatment", "inc.d17", "inc.d9", "hypothalamus")
```

```{r  eval=T}
inc.d17.hatch <- createDEGdfsave(dds.hypothalamus, "treatment", "hatch", "inc.d17", "hypothalamus") 
```

```{r  eval=T}
hatch.n5 <- createDEGdfsave(dds.hypothalamus, "treatment", "n5", "hatch", "hypothalamus") 
```

```{r  eval=T}
n5.n9 <- createDEGdfsave(dds.hypothalamus, "treatment", "n9", "n5", "hypothalamus") 
```
...
```{r  eval=T}
n5.extend <- createDEGdfsave(dds.hypothalamus, "treatment", "n5", "extend", "hypothalamus")
```


```{r eval=T}
sex <- createDEGdfsave(dds.hypothalamus, "sex", "male", "female", "hypothalamus") 
```


```{r volcanos-hypothalamus, fig.height= 6, fig.width=6}
...
char <- plot_grid(
          ...
          nrow = 1, rel_widths = c(1.2,1,1,1,1,1,1))
...
remove <- plot_grid( 
          ...
          NULL, nrow = 1, rel_widths = c(1.2, 1, 1,1,1,1,1))
