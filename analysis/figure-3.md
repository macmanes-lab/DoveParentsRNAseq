...
![](../figures/fig3-1.png)
    ...
    ##    rowname   AR CGNRH.R CYP19A1 ESR1 FSHB FSHR GNRH1 GNRHR HSD17B1 HSD3B2
    ## 1       AR          .59    -.21  .34  .38  .52   .06   .55     .57    .56
    ## 2  CGNRH-R  .59            -.28  .31  .46  .69   .22   .75     .81    .74
    ## 3  CYP19A1 -.21    -.28         -.25 -.10 -.41   .35  -.12    -.19   -.25
    ## 4     ESR1  .34     .31    -.25       .35  .33   .10   .39     .33    .29
    ## 5     FSHB  .38     .46    -.10  .35       .38   .18   .56     .59    .65
    ## 6     FSHR  .52     .69    -.41  .33  .38        .08   .60     .65    .63
    ## 7    GNRH1  .06     .22     .35  .10  .18  .08         .34     .29    .27
    ## 8    GNRHR  .55     .75    -.12  .39  .56  .60   .34           .76    .69
    ## 9  HSD17B1  .57     .81    -.19  .33  .59  .65   .29   .76            .85
    ## 10  HSD3B2  .56     .74    -.25  .29  .65  .63   .27   .69     .85       
    ## 11   LHCGR  .42     .36    -.33  .08  .31  .45  -.14   .32     .35    .50
    ## 12     PGR  .36     .10     .54  .14  .07  .03   .37   .13     .10    .04
    ## 13     PRL -.19    -.15     .14  .02  .60 -.21   .04  -.04     .02    .12
    ## 14    PRLR  .03     .04     .11 -.21 -.13  .04   .01  -.07    -.01   -.10
    ## 15     VIP  .08     .35     .31  .21  .18  .09   .38   .44     .31    .20
    ## 16   VIPR1  .47     .64    -.29  .30  .21  .62   .17   .50     .54    .43
    ##    LHCGR  PGR  PRL PRLR  VIP VIPR1
    ## 1    .42  .36 -.19  .03  .08   .47
    ## 2    .36  .10 -.15  .04  .35   .64
    ## 3   -.33  .54  .14  .11  .31  -.29
    ## 4    .08  .14  .02 -.21  .21   .30
    ...
    ##    rowname   AR CYP19A1 ESR1 FSHB FSHR GNRH1 GNRHR HSD17B1 HSD3B2 LHCGR
    ## 1       AR         -.41 -.07  .16 -.25  -.34   .31    -.19   -.32  -.28
    ## 2  CYP19A1 -.41          .16 -.47  .60   .70   .07     .55    .70   .70
    ## 3     ESR1 -.07     .16       .09  .21   .09  -.36     .20    .20   .16
    ## 4     FSHB  .16    -.47  .09      -.48  -.50  -.20    -.53   -.64  -.62
    ## 5     FSHR -.25     .60  .21 -.48        .66   .12     .72    .77   .75
    ## 6    GNRH1 -.34     .70  .09 -.50  .66         .07     .67    .74   .75
    ## 7    GNRHR  .31     .07 -.36 -.20  .12   .07           .13    .16   .16
    ## 8  HSD17B1 -.19     .55  .20 -.53  .72   .67   .13            .82   .78
    ## 9   HSD3B2 -.32     .70  .20 -.64  .77   .74   .16     .82          .87
    ## 10   LHCGR -.28     .70  .16 -.62  .75   .75   .16     .78    .87      
    ## 11     PGR  .58    -.59 -.27  .43 -.62  -.67   .20    -.68   -.70  -.69
    ## 12     PRL -.23    -.21 -.12  .11 -.11  -.09  -.26    -.06   -.05  -.08
    ## 13    PRLR -.52     .60  .14 -.33  .46   .48   .13     .36    .58   .49
    ## 14     VIP -.14     .57  .06 -.40  .46   .61   .11     .48    .55   .53
    ## 15   VIPR1 -.20     .18  .01 -.19  .16   .16  -.13     .22    .29   .29
    ## 16 CGNRH-R -.30     .34 -.25  .17 -.13   .27  -.07    -.17    .02  -.16
    ##     PGR  PRL PRLR  VIP VIPR1 CGNRH.R
    ## 1   .58 -.23 -.52 -.14  -.20    -.30
    ## 2  -.59 -.21  .60  .57   .18     .34
    ## 3  -.27 -.12  .14  .06   .01    -.25
    ## 4   .43  .11 -.33 -.40  -.19     .17
    ...
    ##    rowname   AR CYP19A1 ESR1 FSHB FSHR GNRH1 GNRHR HSD17B1 HSD3B2 LHCGR
    ## 1       AR          .81  .78  .55 -.48  -.16   .67     .82    .13   .81
    ## 2  CYP19A1  .81          .79  .66 -.45  -.22   .76     .95    .21   .93
    ## 3     ESR1  .78     .79       .46 -.67  -.09   .54     .77    .01   .72
    ## 4     FSHB  .55     .66  .46      -.19  -.14   .72     .58    .05   .60
    ## 5     FSHR -.48    -.45 -.67 -.19        .06  -.26    -.48    .17  -.38
    ## 6    GNRH1 -.16    -.22 -.09 -.14  .06        -.21    -.23   -.20  -.25
    ## 7    GNRHR  .67     .76  .54  .72 -.26  -.21           .69    .15   .74
    ## 8  HSD17B1  .82     .95  .77  .58 -.48  -.23   .69            .26   .90
    ## 9   HSD3B2  .13     .21  .01  .05  .17  -.20   .15     .26          .32
    ## 10   LHCGR  .81     .93  .72  .60 -.38  -.25   .74     .90    .32      
    ## 11     PGR  .74     .77  .96  .42 -.66  -.09   .49     .75   -.09   .67
    ## 12     PRL -.17    -.22 -.18  .10  .14   .08  -.31    -.18   -.02  -.27
    ## 13    PRLR -.57    -.71 -.50 -.45  .44   .23  -.66    -.72   -.23  -.71
    ## 14     VIP -.18     .11 -.32  .53  .20  -.04   .47    -.07    .21   .20
    ## 15   VIPR1  .55     .57  .51  .44 -.28  -.07   .51     .49   -.13   .52
    ## 16 CGNRH-R  .07     .02  .01 -.11 -.07   .06   .39     .04    .03   .15
    ##     PGR  PRL PRLR  VIP VIPR1 CGNRH.R
    ## 1   .74 -.17 -.57 -.18   .55     .07
    ## 2   .77 -.22 -.71  .11   .57     .02
    ## 3   .96 -.18 -.50 -.32   .51     .01
