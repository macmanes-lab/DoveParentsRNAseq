...
a <- plotcandidatemanp(hypvsdf, "HTR2C", "hypothalamus") 
c <- plotcandidatemanp(pitvsdf, "PRL", "pituitary")
e <- plotcandidatemanp(gonvsdf, "ESR2", "gonads") 
b <- plotcandidatemanp(hypvsdm, "HTR2C", "hypothalamus") 
d <- plotcandidatemanp(pitvsdm, "PRL", "pituitary")
f <- plotcandidatemanp(gonvsdm, "ESR2", "gonads") 
boxplots3 <- plot_grid(a,b,c,d,e,f, nrow = 3, 
                       labels = c("A", "", "B", " ", "C"),
